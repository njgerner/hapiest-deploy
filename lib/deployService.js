...
class DeployService {
     ...
     * @property {boolean} [runPreHookFunction=false] - if true, will run pre-hook function before kicking off deployment and stop deployment if it throws an error
     */
    ...
    deploy(deployRequest) {
        return Promise.resolve()
            .then(() => {
                ...
                const preHookFunction = deployRequest.runPreHookFunction ? this._preHookFunction : null;
